// components/StockItem.js - Mit Durchschnittspreis-Anzeige (Refactored)
      ...
      <View style={styles.stockRow}>
        ...
        <View style={styles.statusRow}>
          ...
          {fontsLoaded && (isWarning || isCritical) && (
            <Ionicons 
              name={isCritical ? "close-circle-outline" : "warning-outline"} 
              size={Theme.icons.sm} 
              color={isCritical ? Theme.colors.statusCritical : Theme.colors.statusAlert} 
            />
          )}
